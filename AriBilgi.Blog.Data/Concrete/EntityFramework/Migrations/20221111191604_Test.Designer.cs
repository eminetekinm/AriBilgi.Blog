            ...
            modelBuilder.Entity("AriBilgi.Blog.Entities.Concrete.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2022, 11, 11, 22, 16, 3, 873, DateTimeKind.Local).AddTicks(6822),
                            Title = "TEST DATA",
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("AriBilgi.Blog.Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2022, 11, 11, 22, 16, 3, 875, DateTimeKind.Local).AddTicks(8472),
                            Title = "Test Kategori"
                        });
                });
            ...
            modelBuilder.Entity("AriBilgi.Blog.Entities.Concrete.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Content = "Test yorum",
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2022, 11, 11, 22, 16, 3, 877, DateTimeKind.Local).AddTicks(8113),
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("AriBilgi.Blog.Entities.Concrete.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2022, 11, 11, 22, 16, 3, 879, DateTimeKind.Local).AddTicks(5072),
                            Mail = "test@gmail.com",
                            Name = "Test",
                            Password = "TestTest",
                            PhoneNumber = 0,
            ...
            modelBuilder.Entity("AriBilgi.Blog.Entities.Concrete.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2022, 11, 11, 22, 16, 3, 880, DateTimeKind.Local).AddTicks(5633),
